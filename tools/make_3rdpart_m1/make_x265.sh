...
cmake ../source -DENABLE_ASSEMBLY=OFF -DHIGH_BIT_DEPTH=ON -DEXPORT_C_API=OFF -DENABLE_SHARED=OFF -DENABLE_CLI=OFF -DMAIN12=ON
make -j4

cd ${basepath}/Eyer3rdpart/${X265_SRC}/x265_build_10bit
cmake ../source -DENABLE_ASSEMBLY=OFF -DHIGH_BIT_DEPTH=ON -DEXPORT_C_API=OFF -DENABLE_SHARED=OFF -DENABLE_CLI=OFF
make -j4
